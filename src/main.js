...
var common_1 = require("@nestjs/common"); // Import Logger
function bootstrap() {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    // Enable logging
                    common_1.Logger.log('Application is starting...'); // Use Logger directly
                ...
                case 2:
                    _c.sent();
                    common_1.Logger.log("Application is running on: http://localhost:".concat((_b = process.env.PORT) !== null && _b !== void 0 ? _b : 3000)); // Log application URL
                    return [2 /*return*/];
            }
        });
    });
