...
var JobController = function () {
    var _classDecorators = [(0, common_1.Controller)('jobs')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _createJob_decorators;
    var _getJobsByTask_decorators;
    ...
    var JobController = _classThis = /** @class */ (function () {
        ...
        JobController_1.prototype.createJob = function (taskId, type) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.jobService.createJob(taskId, type)];
                });
            });
        };
        JobController_1.prototype.getJobsByTask = function (taskId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.jobService.getJobsByTask(taskId)];
                });
            });
        };
        JobController_1.prototype.updateJob = function (id, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.jobService.updateJob(id, data)];
                });
            });
        };
        JobController_1.prototype.deleteJob = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.jobService.deleteJob(id)];
                });
            });
        };
    ...
    (function () {
        ...
        _createJob_decorators = [(0, common_1.Post)()];
        _getJobsByTask_decorators = [(0, common_1.Get)(':taskId')];
        _updateJob_decorators = [(0, common_1.Patch)(':id')];
        _deleteJob_decorators = [(0, common_1.Delete)(':id')];
        ...
        __esDecorate(_classThis, null, _getJobsByTask_decorators, { kind: "method", name: "getJobsByTask", static: false, private: false, access: { has: function (obj) { return "getJobsByTask" in obj; }, get: function (obj) { return obj.getJobsByTask; } }, metadata: _metadata }, null, _instanceExtraInitializers);
