...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.signUp = function (email, password, role) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.authService.signUp(email, password, role)];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/, {
                        ...
                        case 2:
                            ...
                            if (error_1 instanceof common_1.HttpException) {
                                throw new common_1.HttpException(error_1.message, error_1.getStatus());
                            }
                            else {
