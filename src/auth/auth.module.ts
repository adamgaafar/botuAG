...
import { ProfileController } from '../profile/profile.controller'; // Corrected relative import path
...
@Module({
  ...
  controllers: [AuthController,ProfileController], // Add AuthController here
  exports: [AuthService],
})
