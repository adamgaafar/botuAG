...
var AppController = function () {
    ...
    var _testDB_decorators;
    var _healthCheck_decorators;
    var _getDeployments_decorators;
    var AppController = _classThis = /** @class */ (function () {
        function AppController_1() {
            this.prisma = (__runInitializers(this, _instanceExtraInitializers), new client_1.PrismaClient());
        }
        AppController_1.prototype.getHello = function () {
            return { message: 'eshta8al World!' }; // Ensure this matches the expected response
        };
        AppController_1.prototype.testDB = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.user.findMany()]; // Fetch all users
                });
            });
        };
        ...
        AppController_1.prototype.getDeployments = function () {
            return [
    ...
    (function () {
        ...
        _testDB_decorators = [(0, common_1.Get)('test-db')];
        _healthCheck_decorators = [(0, common_1.Get)('health')];
        _getDeployments_decorators = [(0, common_1.Get)('deployments')];
        ...
        __esDecorate(_classThis, null, _testDB_decorators, { kind: "method", name: "testDB", static: false, private: false, access: { has: function (obj) { return "testDB" in obj; }, get: function (obj) { return obj.testDB; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        __esDecorate(_classThis, null, _getDeployments_decorators, { kind: "method", name: "getDeployments", static: false, private: false, access: { has: function (obj) { return "getDeployments" in obj; }, get: function (obj) { return obj.getDeployments; } }, metadata: _metadata }, null, _instanceExtraInitializers);
